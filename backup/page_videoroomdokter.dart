...
class VideoRoomDokterHome extends StatefulWidget {
  ...
  const VideoRoomDokterHome(this.getIDUser);
  @override
  _VideoRoomDokterHomeState createState() => _VideoRoomDokterHomeState(getDokter: this.getIDUser);
}

class _VideoRoomDokterHomeState extends State<VideoRoomDokterHome> {
  static final _users = <int>[];
  final _infoStrings = <String>[];
  String getDokter = '';

  _VideoRoomDokterHomeState({this.getDokter});
  ...
  void _getVideoDetail() async {
    final response = await http.get(
        "https://duakata-dev.com/miracle/api_script.php?do=getdata_videodetail&id="+widget.getIDUser);
