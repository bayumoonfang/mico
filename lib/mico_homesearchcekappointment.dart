...
class CekAppointmentHome extends StatefulWidget {
  final String idJadwal, idUser, idDokter;
  const CekAppointmentHome(this.idJadwal, this.idUser, this.idDokter);
  @override
  _CekAppointmentHomeState createState() =>
      _CekAppointmentHomeState(
...
class _CekAppointmentHomeState extends State<CekAppointmentHome> {
  String
  getIDJadwal,
      getUser,
      getDokter,
    ...
    setState(() {
      ...
      if (getMessage == '2') {
        ...
        Navigator.of(context)
            .pushReplacement(new MaterialPageRoute(builder: (BuildContext context) => CheckoutHome(
            getIDJadwal,
            getUser,
            getDokter)));
      }
