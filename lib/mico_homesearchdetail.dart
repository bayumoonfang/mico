...
class DetailDokterHome extends StatefulWidget {
  final String iddokter;
  final String namaDokter;



  const DetailDokterHome(this.iddokter, this.namaDokter);
  @override
  _DetailDokterHomeState createState() => new _DetailDokterHomeState();
}

class _DetailDokterHomeState extends State<DetailDokterHome> {
  String getAcc;
                        ...
                        RaisedButton(
                          ...
                          onPressed: () {
                            Navigator.of(context).push(new MaterialPageRoute(
                                builder: (BuildContext context) => CekAppointmentHome(_isGetJadwal.toString(),getAcc.toString(),widget.iddokter)));
                          },
                        ),
