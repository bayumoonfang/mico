...
class VideoHistory extends StatefulWidget {
  ...
  const VideoHistory(this.getPhone);
  @override
  _VideoHistoryState createState() => new _VideoHistoryState(getPhoneState: this.getPhone);
}
...
class _VideoHistoryState extends State<VideoHistory> {
  ...
  _VideoHistoryState({this.getPhoneState});
  ...
  Future<List> getData() async {
    final response = await http.get(
        "https://duakata-dev.com/miracle/api_script.php?do=getdata_transaksivideo&id=" +
            getPhoneState);
    setState((){
